...
My_Filter::My_Filter(){
        scan_sub_ = node_.subscribe<sensor_msgs::LaserScan> ("/mybot/laser/scan", 100, &My_Filter::scanCallback, this);
...
void My_Filter::scanCallback(const sensor_msgs::LaserScan::ConstPtr& scan){
    ...
    projector_.transformLaserScanToPointCloud("chassis", *scan, cloud, tfListener_);
